...
class AnalyticsManager {
  ...
  endLevel(levelId, successful, timeTakenMs, xp) {
    ...
    if (level) {
      ...
      console.log(`[Analytics] Level ${successful ? 'completed' : 'ended'}:`, levelId, {
        timeTaken: (timeTakenMs / 1000).toFixed(2) + 's',
        xp: xp,
        totalXP: this._reportData.xpEarnedTotal
      });
    } else {
  ...
  submitReport() {
    ...
    // Log submission with detailed banner
    console.log('═══════════════════════════════════════════════════════');
    ...
    console.log('Raw Metrics:', payload.rawData.length, 'entries');
    console.log('═══════════════════════════════════════════════════════');

document.addEventListener('DOMContentLoaded', async () => {
    ...
    const GAME_ID = 'crossmath_multiplication';
    ...
    function loadProgress() {
        ...
        const savedProgress = localStorage.getItem('crossMathMultiplicationPlayerProgress');
        if (savedProgress) {
    ...
    function saveProgress() {
        if (gameManager) {
            ...
            localStorage.setItem('crossMathMultiplicationPlayerProgress', JSON.stringify(playerProgress));

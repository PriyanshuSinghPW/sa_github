document.addEventListener('DOMContentLoaded', async () => {
    ...
    const GAME_ID = 'crossmath_substraction';
    ...
    function loadProgress() {
        ...
        const savedProgress = localStorage.getItem('crossMathSubtractionPlayerProgress');
        if (savedProgress) {
    ...
    function saveProgress() {
        if (gameManager) {
            ...
            localStorage.setItem('crossMathSubtractionPlayerProgress', JSON.stringify(playerProgress));
